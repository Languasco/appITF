...
@Component({
  selector: 'app-programacion-boticas-farmacias',
  templateUrl: './programacion-boticas-farmacias.component.html',
  styleUrls: ['./programacion-boticas-farmacias.component.css']
}) 
export class ProgramacionBoticasFarmaciasComponent implements OnInit {
 ...
 mostrarInformacion(){
    ...
    this.spinner.show();
    this.programacionService.get_mostrarProgramaciones_boticasFarmacias( this.formParamsFiltro.value)
