...
@Component({
  selector: 'app-solicitud-direccion',
  templateUrl: './solicitud-direccion.component.html',
  styleUrls: ['./solicitud-direccion.component.css']
})
export class SolicitudDireccionComponent implements OnInit {
...
inicializarFormularioDireccion(){ 
 ...
 async saveUpdate(){ 
  ...
  this.formParamsMedico.patchValue({ "idMedico" :  $('#cboMedico').val() }); 
 ...
 editar({ id_Sol_Medico_Direccion,id_Medicos_Direccion, id_Medico, idEstado,descripcionEstado }){
